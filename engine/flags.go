...
func parseFlags() options {
	...
	flag.BoolVar(&o.changePass, "change-pass", true, "set a new password when an AP demands a change at first login (-change-pass=false to skip such APs)")
	...
	flag.DurationVar(&o.watch, "watch-for", 0, "stop re-scanning after this long instead of waiting to be interrupted")
